...
class FastLedClass {
	public:
		static void addLeds(struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 0);
		void showColor(const struct CRGB color);
		void showColor(const struct CRGB color, unsigned int intensity);
		void show();
		void show(int scale);
};
